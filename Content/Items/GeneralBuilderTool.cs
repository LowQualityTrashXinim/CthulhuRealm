...
namespace CthulhuRealm.Content.Items;
...
public class ImprovedUIImage : UIImage {
	...
	public sealed override void Draw(SpriteBatch spriteBatch) {
		...
		if (postTex != null) {
			...
			Vector2 drawpos = GetInnerDimensions().Position();
...
internal class GeneralBuilderTool : ModItem {
	...
	public override void ModifyTooltips(List<TooltipLine> tooltips) {
        //TODO : someone ( probably me ) create a guide to how to use this tool 
		string text = "";
